                    ...
                    <Tabs
                        ...
                        <TabPanel tabId="autoReparing">
                            <article className='tab-left-article'>
                                ...
                                <p>Histrionically one along far coast amenable scandalously arrogant a crucially since far hence pounded flexed because unjustifiably bluebird winced far spon etaneous oirksome spelled one yikes this thus hence this against above. Against abortively darn took yikes black returned bet in the slight shook far extrins burra like ponderously inescapably closed sudden unsafely hey superbly much.</p>
                            </article>
                        ...
                        <TabPanel tabId="transmissionChekup">
                            <article className='tab-left-article'>
                                ...
                                <p>Against abortively darn took yikes black returned bet in the slight shook far extrins burra like ponderously inescapably closed sudden unsafely hey superbly much. Histrionically one along far coast amenable scandalously arrogant a crucially since far hence pounded flexed because unjustifiably bluebird winced far spon etaneous oirksome spelled one yikes this thus hence this against above.</p>
                            </article>
                        ...
                        <TabPanel tabId="vehicleInspection">
                            <article className='tab-left-article'>
                                ...
                                <p>Darn took yikes black returned bet in the slight shook far extrins burra like ponderously inescapably closed sudden unsafely hey superbly much.Histrionically one along far coast amenable scandalously arrogant a crucially since far hence pounded flexed because unjustifiably bluebird winced far spon etaneous oirksome spelled one yikes this thus hence this against above.</p>
                            </article>
