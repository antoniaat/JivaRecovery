...
function VehicleSearch() {
    ...
    const makesOfTheVehicleOptions = ['Volswagen', 'Maserati', 'Audi', 'BMW', 'Mercedes benz', 'Lamborgini', 'Lexux', 'Ferrari', 'Bentley', 'Land Rover', 'Dodge', 'Jaguar'];
        ...
        <div className='VehicleSearch'>
            ...
            <section>
                ...
                <article>
                    ...
                    <Dropdown options={modelsOptions} value={modelsDefaultOption} placeholder="Select an option" />
                </article>

                <article>
                    <h6>Condition</h6>
                    <Dropdown options={vehicleStatusOptions} value={vehicleStatusDefaultOption} placeholder="Select an option" />
                </article>

                <article>
                    <h6>Fuel Type</h6>
                    <Dropdown options={fuelTypeOptions} value={fuelTypesDefaultOption} placeholder="Select an option" />
                </article>
