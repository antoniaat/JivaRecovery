...
let vehicleSchema = new mongoose.Schema({
  ...
  transmission: { type: mongoose.Schema.Types.String, required: REQUIRED_VALIDATION_MESSAGE },
  rental: { type: mongoose.Schema.Types.Boolean, required: REQUIRED_VALIDATION_MESSAGE },
  img: { type: mongoose.Schema.Types.String, required: REQUIRED_VALIDATION_MESSAGE },
  offers: [{ type: mongoose.Schema.Types.Number, required: REQUIRED_VALIDATION_MESSAGE }],
  owner: { type: mongoose.Schema.Types.String, required: REQUIRED_VALIDATION_MESSAGE },
